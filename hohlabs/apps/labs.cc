...
nokey:
  ...
  hoh_debug("Producer writes at "<<apps.channel0_writeport_write_index_tmp);
...
norender:
  ...
  hoh_debug("Producer deletes at "<<apps.channel0_writeport_delete_index_tmp);
...
rank1:
  ...
  hoh_debug("Consumer reads at "<<apps.channel0_readport_read_index_tmp);
